...
// here this mean, authentication and then authorization between microservices by sent token to other services by AuthenticationRequestInterceptor.class
public interface ProfileClient {
    ...
    // when call api to profile service, then profile service need to have a token to authentication and authorization , if not, security in profile service will prevent
